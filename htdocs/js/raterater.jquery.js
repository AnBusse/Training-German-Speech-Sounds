/*
 * JQuery file for the star-based user rating system:
 *  Raterater 1.1.1
...
;(function( $ ) {
     ...
     * (This is only complicated because of the spacing between stars)
     */
